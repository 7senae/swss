...
if(member.voiceChannelID === '493077320056438815') {
...
deny: ['CONNECT']
    ...
    const parent = member.guild.channels.get('493077320056438815').parentID
...
message.guild.members.get(user.id).setVoiceChannel('493077320056438815'); // المكان الي راح ينحطوله بعد ما يصير لهم lock
}  
} catch (error) {
console.log(error)
}
