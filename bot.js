...
client.on("ready", () => {
    client.user.setPresence({ game: { name: `RainBow Roles! Created by i am iiBlueGamer295YT| SK ♕#1124` }, type: 0 });
    console.log("RainBow role bot online! Created by i am BlueGamer.");
});
